...
class SResourceInspectorExtender {

  private static _instance: SResourceInspectorExtender;
...
const ResourceInspectorExtender = SResourceInspectorExtender.Instance;
export default ResourceInspectorExtender;
